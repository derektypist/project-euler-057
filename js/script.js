...
function getNumberInfo() {
    ...
    if (isNaN(num) || num.length == 0 || num < 10 || num > 1000 || (num.length > 1 && num[0] == "0") || !Number.isInteger(Number(num))) {
        txt += `Invalid Input.  Please enter a whole number between 10 and 1000.  Do not include leading zeros.`;
    } else {
